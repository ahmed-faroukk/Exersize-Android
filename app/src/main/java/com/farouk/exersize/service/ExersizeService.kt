package com.farouk.exersize.service
...
class ExersizeService : Service() {
    ...
    private fun startForegroundService() {
        ...
        val notification: Notification = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
            .setSmallIcon(R.drawable.sec_logo)
            .setContentTitle("Exersize")
            .setContentText("build your muscles with us :) ")
    ...
    fun stopService(context : Context){
        val intent = Intent(context, ExersizeService::class.java).apply {
